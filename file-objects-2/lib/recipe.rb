...
class Recipe
  ...
  def save_to_file
    objeto = Recipe.new(title: title, description:description, ingredients:ingredients, cook_time:cook_time, featured: false)
    File.write('data/recipe.json', objeto.to_json) 
  end
end
